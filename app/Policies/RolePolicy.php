...
class RolePolicy
{
    ...
    {
        return $user->checkPermissionAccess('show_role');
    }


    public function viewDelete(User $user)
    {
        return $user->checkPermissionAccess('viewDelete_role');
    }
    /**
    ...
    {
        return $user->checkPermissionAccess('deleteChecked_role');
    }
    /**
    ...
    {
        return $user->checkPermissionAccess('restore_role');
    }

    public function restoreAll(User $user)
    {
        return $user->checkPermissionAccess('restoreAll_role');
    }
